...
@section('content')
    ...
    <div class="flex flex-row justify-center text-center items-center py-5">
      ...
      <h1 class="text-3xl text-center ml-8 font-bold"> Edit Categoria</h1>

    </div>  
     
      <form action="{{route('admin.categoria.update',['categoria' => $categoria->id])}}" method="POST" enctype="multipart/form-data" class="max-w-lg mx-auto my-10">
