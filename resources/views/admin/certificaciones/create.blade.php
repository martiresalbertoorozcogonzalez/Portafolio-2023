...
@section('content')
    ...
    <div class="flex flex-row justify-center text-center items-center py-5">
      ...
      <h1 class="text-3xl text-center ml-8 font-bold">Certificacion</h1>

    </div>  
     
      <form action="{{ route('admin.certificacion.store') }}" method="POST" enctype="multipart/form-data" class="max-w-lg mx-auto my-10">

        @csrf

        <div class="mb-5">
            <label for="nombre" class="block text-gray-700 font-medium text-sm mb-2">Nombre Certificacion</label>
        ...
        <div class="mb-5">
            ...
            <input name="imagen_certificacion" class="block w-full text-sm text-black border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-100 focus:outline-none dark:bg-blue-500 dark:border-blue-600 dark:placeholder-gray-50" aria-describedby="file_input_help" id="file_input" type="file">
